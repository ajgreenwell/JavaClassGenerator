...
Afterwards, your new class file will be generated and stored in the same directory. Note that if you provide a relative path to the interface file, your class file will be stored in that directory instead. For example, if you ran the following command...
